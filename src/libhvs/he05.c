// Hermite functions up until 5th order
...
FLOAT_TYPE he(FLOAT_TYPE x1, FLOAT_TYPE x2, FLOAT_TYPE lambda_sq, unsigned short k1, unsigned short k2) {
	...
	if ( (k1==0) && (k2==0) )
		...
		ret = he_00(x1,x2,lambda_sq)*(-2*x1)/lambda_sq;
	else if ( (k1==0) && (k2==1) )
		ret = he_00(x1,x2,lambda_sq)*(-2*x2)/lambda_sq;
	else if ( (k1==2) && (k2==0) )
		ret = he_00(x1,x2,lambda_sq)*(-2*lambda_sq+4*x1*x1)/lambda_sq/lambda_sq;
	else if ( (k1==1) && (k2==1) )
		ret = he_00(x1,x2,lambda_sq)*(4*x1*x2)/lambda_sq/lambda_sq;
	else if ( (k1==0) && (k2==2) )
		ret = he_00(x1,x2,lambda_sq)*(-2*lambda_sq+4*x2*x2)/lambda_sq/lambda_sq;
	else {
#if HVS_DEBUG
